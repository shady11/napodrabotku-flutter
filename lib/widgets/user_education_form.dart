...
class UserEducationForm extends StatefulWidget {
  ...
  UserEducationForm({Key key, this.education, this.onDelete, this.index}):super(key: key);
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  onChanged: (value){
                    StoreProvider.of<AppState>(context).state.user.user_cv.data.user_educations[widget.index].title = value;
                  },
                ),
              ),
              SizedBox(height: 10,),
...
//                      widthFactor: 10,
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  onChanged: (value){
                    StoreProvider.of<AppState>(context).state.user.user_cv.data.user_educations[widget.index].faculty = value;
                  },
                ),
              ),
              SizedBox(height: 10,),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  onChanged: (value){
                    StoreProvider.of<AppState>(context).state.user.user_cv.data.user_educations[widget.index].speciality = value;
                  },
                ),
              ),
              SizedBox(height: 10,),
...
//                      widthFactor: 10,
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  onChanged: (value){
                    StoreProvider.of<AppState>(context).state.user.user_cv.data.user_educations[widget.index].end_year = value;
                  },
                ),
              ),
              SizedBox(height: 10,),
